...
class TestSum(unittest.TestCase):
    ...
    def test01_login(self):
        # get browser
        browser = rsvp_meetup.setup()
        # login
        rsvp_meetup.login(browser)
        # test after login
        after_login = rsvp_meetup.is_logged_in(browser)
        self.assertEqual(after_login, True)

    # new_coming_event_count function test
    def test02_count_no_event(self):
        # update group name
        rsvp_meetup.update_group_name(GROUP_NAME_NO_EVENT)
        # get browser
        browser = rsvp_meetup.setup()
        # login
        rsvp_meetup.login(browser)
        # new_coming_event_count function test
        test_result = rsvp_meetup.new_coming_event_count(browser)
        self.assertEqual(test_result, 0)

    def test03_count_multi_event(self):
        # update group name
        rsvp_meetup.update_group_name(GROUP_NAME_MULTI_EVENTS)
        # get browser
        browser = rsvp_meetup.setup()
        # login
        rsvp_meetup.login(browser)
    ...
    def test04_count_one_already_rsvp(self):
        # update group name
        rsvp_meetup.update_group_name(GROUP_NAME_ONE_ALREADY_RSVP)
        # get browsr
        browser = rsvp_meetup.setup()
        # login
        rsvp_meetup.login(browser)
    ...
    def test05_count_one_available(self):
        # update group name
        rsvp_meetup.update_group_name(GROUP_NAME_ONE_AVAILABLE)
        # get browser
        browser = rsvp_meetup.setup()
        # login
        rsvp_meetup.login(browser)
    ...
    def test06_available_one_already_rsvp(self):
        ...
        rsvp_meetup.login(browser)
        # is_event_available function test
        test_result = rsvp_meetup.is_event_available(browser)
        self.assertEqual(test_result, 2)

    def test07_available_one_cannot_go(self):
        # update group name
        rsvp_meetup.update_group_name(GROUP_NAME_ONE_CANNOT_GO)
        browser = rsvp_meetup.setup()
        rsvp_meetup.login(browser)
        # new_coming_event_count function test
        test_result = rsvp_meetup.new_coming_event_count(browser)
    ...
    def test09_rsvp_is_rsvp_check_yes(self):
        ...
        test_result = rsvp_meetup.is_rsvp_check(browser)
